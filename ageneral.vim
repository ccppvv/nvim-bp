" general config {
    ...
    set suffixesadd=.js,.jsx,.ts,.tsx,.css,.scss,.json
...
" Formatting {
    ...
    augroup FiletypeGroup
      autocmd!
      " au BufNewFile,BufRead *.jsx set filetype=typescript.tsx
...
" Key (re)Mappings {
    ...
    " }
      ...
      nmap <leader>k :e ~/.config/nvim/init.vim<cr>
